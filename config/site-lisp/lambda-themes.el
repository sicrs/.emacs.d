...
;; Copyright (C) 2020 Colin McLear, 2025 sicrs
;; -------------------------------------------------------------------
;; Authors: Colin McLear, sicrs
;; -------------------------------------------------------------------
...
;;;;;; Outline
     ...
     `(outline-1            ((,class (:inherit 'default :weight bold :foreground ,lambda-fg))))
     `(outline-2            ((,class (:inherit 'default :weight bold :foreground ,lambda-meek))))
     `(outline-3            ((,class (:inherit 'default :weight bold :foreground ,lambda-fg))))
     `(outline-4            ((,class (:inherit 'default :weight bold :foreground ,lambda-meek))))
